...
<body>
    ...
    <!-- header -->
    <div id="header">
    <form class="join_form"  method="post" action="update_result.php" onsubmit=" return Validation()">
    <!-- wrapper -->
    <div id="wrapper">
        ...
        <div id="content">
           ...
           <div>
                <h3 class="join_title">
                    <label for="id">정보수정</label>
                </h3>
                <span class="box int_name">
                    <p>이름 </p> <input type="text" id="name" name="CLI_NAME" class="int" maxlength="20" placeholder="이름을 입력하세>요">
                </span>
            ...
            <div>
                ...
                <span class="box int_password">
                    <p>비밀번호  </p><input type="password" id="PW" name="PW" class="int" maxlength="20" placeholder="비밀번호를 입력>하세요">
                </span>
                <span class="error_next_box"></span>
            </div>
            ...
            <div>
                <h3 class="join_title"><label for="phoneNo"></label></h3>
                     <span class="box int_mobile">
                          <p>휴대폰 번호  </p><input type="tel" id="mobile" name="PHONE_NUMBER" class="int" maxlength="16" placeholder="휴대폰 번호를 입력하세요">
                    </span>
                    <span class="error_next_box"></span>
             </div>
                ...
                <div class="btn_area">
                    <script language="javascript">
                        ...
                        //function showPopup(){window.open("popup.html","가입축하 팝업창"," resizable=yes, height=' + popupHeight  + ', width=' + popupWidth  + ', left='+ popupX + ', top='+ popupY");}
                    </script>
                    <input type="submit" value = "수정하기" id="btnJoin">
                    </input>
